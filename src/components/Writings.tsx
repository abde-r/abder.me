        ...
        <div id='blog' className="w-[80%] mx-auto items-center flex flex-col font-fira font-normal text-base justify-center h-[90vh] max-md:h-[100%] max-md:w-[65%] max-md:py-10">
          ...
          >
            ...
            <div className="flex flex-col justify-between px-4 leading-normal w-full">
              <h1 className="mb-2 text-lg font-bold tracking-tight text-black">{writing.meta.title}</h1>
              <h5 className="mb-2 text-sm  tracking-tight text-gray-900">{writing.meta.date}</h5>
              <p className="mb-3 text-sm text-gray-900">{writing.meta.description}</p>
            </div>
          </Link>
